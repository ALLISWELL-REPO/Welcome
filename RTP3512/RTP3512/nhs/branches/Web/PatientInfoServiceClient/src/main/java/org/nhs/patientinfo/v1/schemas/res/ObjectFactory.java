 ...
 * generated in the org.nhs.patientinfo.v1.schemas.res package. 
...
public class ObjectFactory {
    ...
    private final static QName _PatientInfoRes_QNAME = new QName("http://www.nhs.org/PatientInfo/v1/schemas/Res", "PatientInfoRes");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.nhs.patientinfo.v1.schemas.res
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.nhs.org/PatientInfo/v1/schemas/Res", name = "PatientInfoRes")

...
<body style="background-color: rgb(180, 180, 180);">
	...
	<h3>response code ${webRes.getExpncode() }</h3>
	<c:if test="${webRes.getExpncode() !=000 }">

		<p style="font-size: 50px">Please provide valid data

			${webRes.getExpncode()}</p>

	</c:if>



	<c:if test="{listSize le 0 && webRes.getExpnCode()==000}">

		<p style="font-size: 50px">No transaction found
	...
	<h1>Total no of pages ${noOfPages }</h1>

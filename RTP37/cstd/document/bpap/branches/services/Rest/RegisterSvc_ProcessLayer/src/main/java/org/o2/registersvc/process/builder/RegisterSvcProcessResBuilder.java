...
public class RegisterSvcProcessResBuilder {
	...
	public RegisterSvcProcessVBRes buildSerLayResp(CreditCheckResponse credCheckResp) {
		logger.info("enter into RegisterSvcProcessResBuilder with credCheckResp"+credCheckResp);
	...
	public RegisterSvcProcessVBRes buildSerLayRespWithDaoResp(RegisterSvcDAORes daoResp) {
		...
		RegisterSvcProcessVBRes processVBRes = new RegisterSvcProcessVBRes();
		processVBRes.setRespCode(daoResp.getDaoRespCode());
		processVBRes.setRespMsg(daoResp.getDaoRespMsg());

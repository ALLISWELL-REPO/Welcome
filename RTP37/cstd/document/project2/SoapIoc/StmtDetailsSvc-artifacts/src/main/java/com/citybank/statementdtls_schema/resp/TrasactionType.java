...
/**
 * <p>Java class for TrasactionType complex type.
 * 
 ...
 *         &lt;element name="MarchatName" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
@XmlType(name = "TrasactionType", propOrder = {
    "id",
    "name",
    "desc",
    "marchatName",
...
public class TrasactionType {
    ...
    @XmlElement(name = "MarchatName", required = true)
    ...
    /**
     * Gets the value of the marchatName property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the marchatName property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }

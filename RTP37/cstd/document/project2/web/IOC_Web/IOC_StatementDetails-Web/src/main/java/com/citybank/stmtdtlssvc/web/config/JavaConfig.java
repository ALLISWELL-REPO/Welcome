...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = { "com.citybank.stmtdtlssvc.web.controller", "com.citybank.stmtdtlssvc.web.dao","com.citybank.stmtdtlssvc.web.views","com.citybank.stmtdtlssvc.client.builder" })

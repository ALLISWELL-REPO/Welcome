...
public class StatementDtlsSpringImpl extends StoredProcedure implements StatementDtlsDAO, RowMapper<TransactionsDAO> {

public StatementDtlsSpringImpl(JdbcTemplate jdbcTemplate) {
		super(jdbcTemplate, "getTransactions");
		declareAllParam();
	}
	...
	private void declareAllParam() {
		...
		declareParameter(new SqlReturnResultSet("transactionResult", this));
		compile();
	...
	public StatementDtlsDAORes getTransactions(StatementDtlsDAOReq daoReq)
		...
		if ("0".equals(dbRespCode)) {
			...
			transDtlsDAO=(List<TransactionsDAO>) respMsg.get("transactionResult");
	...
	public static void main(String[] args)
		...
		System.out.println("Enter into DaoLayer");
		ApplicationContext context=new AnnotationConfigApplicationContext(StatementInfoConfig.class);
		System.out.println("bye");
		StatementDtlsDAO spDaoImpl =context.getBean(StatementDtlsDAO.class) ;
	...
	public TransactionsDAO mapRow(ResultSet rs, int arg1) throws SQLException {

...
public class RegisterSvcDAOImpl implements RegisterSvcDAO {
	 ...
	 public RegisterSvcDAORes enrollment(RegisterSvcDAOReq daoReq)
		...
		System.out.println("Enter into RegisterSvcDAOImpl");
		...
		try {
			...
			InputStream reader = RegisterSvcDAOImpl.class.getClassLoader().getResourceAsStream("db_dev.properties");
			properties.load(reader);
		/*	Properties properties=new Properties();
			InputStream stream=new FileInputStream("db_dev.properties");
			properties.load(stream);*/
			System.out.println(properties.getProperty("db.url")+" "+ properties.getProperty("db.userName")+" "+properties.getProperty("db.password"));
		...
		System.out.println("Dao Resp Code and Message in daoLayer::"+daoResp.getDaoRespCode()+daoResp.getDaoRespMsg());
		return daoResp;

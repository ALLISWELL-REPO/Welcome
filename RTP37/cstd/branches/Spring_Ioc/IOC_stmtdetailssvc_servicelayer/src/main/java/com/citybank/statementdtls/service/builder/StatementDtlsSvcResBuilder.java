...
public class StatementDtlsSvcResBuilder {
	...
	public StatementDtlsResType resClientBuilder(StatementDtlsProcessVbRes vbResp) {
		...
		List<TransactionsProcess> transProcess=new ArrayList<TransactionsProcess>();
		transProcess = vbResp.getTransProcess();
		System.out.println("transProcess "+transProcess);
